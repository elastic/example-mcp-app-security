...
**Cursor / VS Code:** Run `npx skills add elastic/example-mcp-app-security` and select `cursor` as the target agent. This copies each skill into `.agents/skills/` for the agent to discover.
